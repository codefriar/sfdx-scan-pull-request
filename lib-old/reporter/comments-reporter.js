...
class CommentsReporter extends base_reporter_1.BaseReporter {
    /**
    ...
    uploadCommentsAsArtifactAndPostComment(comments) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            yield fs_1.promises.writeFile(COMMENTS_FILE_NAME, comments.map((comment) => comment.body).join("\n\n"));
            try {
                let artifactResponse = yield new artifact_1.DefaultArtifactClient().uploadArtifact(COMMENTS_FILE_NAME, [COMMENTS_FILE_NAME], process.cwd());
